importResource("generator/css/common.css");
importResource("generator/admin/css/common.css");
    ...
    require(["miniui-tools", "message", "request"], function (tools, message, request) {
        ...
        function initTemplate(templateList) {
            ...
            $(".add-template").on("click", function () {
                tools.openWindow("generator/code-generator/template.html", "编辑模板", "80%", "80%", function (onClose) {
            ...
            $(".edit-template").on("click", function () {
                tools.openWindow("generator/code-generator/template.html", "编辑模板", "90%", "90%", function (onClose) {
                    if (typeof onClose === 'object') {
                        if (!templateMap[onClose.id]) {
                            templateList.push(onClose);
                            createButton(onClose);
        ...
        $(".write-code").on("click", function () {
            ...
            request.post("code-generator/write", code, function (e) {
                if (e.status === 200) {
