...
Component.prototype.setProperties = function (properties) {
    ...
    $(properties).each(function () {
        me.setProperty(this.id, this.value);
    });
...
(function () {
    ...
    Designer.prototype.getConfig = function () {
        ...
        var components = [];
        var html = $("<div>").append(config.html);
    ...
    Designer.prototype.init = function () {
        ...
        me.loadConfig = function (config) {
            ...
            $(".main-panel .components:first").append(html);
            initDroppable();
            reloadLayui();
        };
        ...
        /**初始化主编辑器**/
        {
            ...
            me.addComponent = function (type) {
                var component = newComponent(type);
                $(".main-panel .components:first").append(component.render());
                return component;
            }
